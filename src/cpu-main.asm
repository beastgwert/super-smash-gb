...
INCLUDE "cpu-character-selection.asm"
...
; Method used by cpu to see if it's in range to hit
CheckA2_virtual: 

    ld a, [wSpriteChangeTimer2]   ; Check if timer is active
    cp a, 1
    ret nc ; a is 1 or greater than 1 --> can't hit
...
CheckA1_virtual:  ; function that cpu uses to check if player can hit cpu
